...
- ТОЛЬКО ключевые слова (5-8 слова максимум)
...
Вопрос пользователя: "В какой платформе строятся дашборды?"
✅ ПРАВИЛЬНО: retrieve_docs(query="дашборды платформа")
✅ ПРАВИЛЬНО: retrieve_docs(query="Power BI дашборды")  
❌ НЕПРАВИЛЬНО: retrieve_docs(query="В какой платформе строятся дашборды?")

Вопрос пользователя: "Какие этапы найма сотрудников?"
✅ ПРАВИЛЬНО: retrieve_docs(query="найм сотрудников")
❌ НЕПРАВИЛЬНО: retrieve_docs(query="Какие этапы найма сотрудников?")

Вопрос пользователя: "Как работает процесс бюджетирования?"
✅ ПРАВИЛЬНО: retrieve_docs(query="бюджетирование")
❌ НЕПРАВИЛЬНО: retrieve_docs(query="Как работает процесс бюджетирования?")

Вопрос пользователя: "Расскажи про бонусную систему"
✅ ПРАВИЛЬНО: retrieve_docs(query="бонусная система")
❌ НЕПРАВИЛЬНО: retrieve_docs(query="Расскажи про бонусную систему")
